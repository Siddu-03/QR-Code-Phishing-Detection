...
async def get_history(
    ...
    # Reading/filtering the JSON-file-backed history store is blocking
    # disk I/O - keep it off the event loop (Change 4).
    result = await run_in_threadpool(
        history_store.list, limit=limit, offset=offset, tampered_only=tampered_only
    )
